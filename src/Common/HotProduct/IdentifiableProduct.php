...
final class IdentifiableProduct implements \JsonSerializable
{
     ...
     */
    public function __construct(string $product_id, string $product_name, string $product_description, string $product_image, Price $price, Currency $currency, Quantity $quantity, ?string $ean = null, ?ProductAvailability $product_availability = null, array $additional_product_images = [], array $product_attributes = [])
    {
