...
final class ActionShipmentUpdateAfter implements HookInterface
{
    public const HOOK_NAME = 'actionObjectInPostShipmentModelUpdateAfter';
    ...
    public function execute(array $parameters): void
    {
        ...
        $this->dispatcher->dispatch(new ShipmentEvent($shipment), ShipmentEvent::UPDATED);
    }
}
