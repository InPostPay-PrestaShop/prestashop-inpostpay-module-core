...
final class ActionProductDeleteBefore implements HookInterface
{
    public const HOOK_NAME = 'actionObjectProductDeleteBefore';
    ...
    public function execute(array $parameters): void
    {
        ...
        $this->dispatcher->dispatch(new ProductEvent($product), ProductEvent::DELETION);
    }
}
