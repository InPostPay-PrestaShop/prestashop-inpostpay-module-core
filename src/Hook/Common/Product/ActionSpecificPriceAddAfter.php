...
final class ActionSpecificPriceAddAfter implements HookInterface
{
    public const HOOK_NAME = 'actionObjectSpecificPriceAddAfter';
    ...
    public function execute(array $parameters): void
    {
        ...
        $this->dispatcher->dispatch(new SpecificPriceEvent($price), SpecificPriceEvent::CREATED);
    }
}
